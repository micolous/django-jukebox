...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.local_path'
        db.add_column('music_db_song', 'local_path', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)

        # Changing field 'Song.file'
        db.alter_column('music_db_song', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Song.local_path'
        db.delete_column('music_db_song', 'local_path')

        # User chose to not deal with backwards NULL issues for 'Song.file'
        raise RuntimeError("Cannot reverse this migration. 'Song.file' and its values cannot be restored.")
